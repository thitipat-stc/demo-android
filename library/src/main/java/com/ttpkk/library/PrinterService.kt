...
class PrinterService(private val context: Context) {
    ...
    @SuppressLint("MissingPermission")
    private fun printerList(): ArrayList<PairedData> {
        val bluetoothManager = context.getSystemService(Context.BLUETOOTH_SERVICE) as BluetoothManager
        val bluetoothAdapter = bluetoothManager.adapter
        val pairedDevices = bluetoothAdapter.bondedDevices as MutableSet<BluetoothDevice>
        val list = ArrayList<PairedData>()
...
@Parcelize
data class PairedData(var display: String, var value: BluetoothDevice? = null) : Parcelable {
